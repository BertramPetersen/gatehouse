...
hero:
  ...
  actions:
    - text: Get Started
      link: /gatehouse/start-here/quick-start/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
      link: https://github.com/BertramPetersen/gatehouse
      icon: external
---
...
branch is already public. `gatehouse` moves more of that loop closer to where
you are working.
...
flowchart LR
  ...
  subgraph after[" With gatehouse "]
    direction TB
    E["Local branch"] -->|"git push gatehouse"| F["Local gate"]
...
- [Quick Start](/gatehouse/start-here/quick-start/) - first gated push in a few minutes
- [Introduction](/gatehouse/start-here/introduction/) - why the tool exists and how to think about it
- [The Gate Model](/gatehouse/concepts/gate-model/) - architecture, push flow, and design choices
