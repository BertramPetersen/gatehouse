...
// test. The registered repo, worktree, socket, and GATEHOUSE_HOME are all real, so
...
// newDaemonDownAbortFixture prepares GATEHOUSE_HOME with a durable run record and no
